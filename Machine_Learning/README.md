...
| 13 |[Collaborative filtering based recommendation system](https://github.com/ruchikaverma-iitg/ML-DL-RL_Codes/blob/master/Machine_Learning/L13-RecSys-Collaborative-Filtering-movies.ipynb) | Collaborative filtering based recommendation system to recommend new movies to a user based on the similarity between the other users who have watched same movies. Following identification of users that have similar preferences and opinions, it recommends items/movies that they have liked to the input. 
