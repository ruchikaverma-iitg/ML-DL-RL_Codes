...
| 12 |[Content based recommendation system](https://github.com/ruchikaverma-iitg/ML-DL-RL_Codes/blob/master/Machine_Learning/L12-RecSys-Content-Based-movies.ipynb) | Content based recommendation system to recommend new movies to users based on the previous ratings or information taken from the user|
