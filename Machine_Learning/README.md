...
| 14 |[The_best_classifier](https://github.com/ruchikaverma-iitg/ML-DL-RL_Codes/blob/master/Machine_Learning/The_best_classifier.ipynb) | Comparing the different models such as K nearest neighbors, decision trees, SVM, and logistic regression. Train the models using best parameters, test them on test-data, and report different metrics such as Jaccard index, F1-score, and logloss|
